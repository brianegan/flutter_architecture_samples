...
void main() {
  group('ExtraActions', () {
    ...
    testWidgets('renders an empty Container if state is not TodosLoaded', (
      ...
      expect(
        find.byKey((BlocLibraryKeys.extraActionsEmptyContainer)),
        findsOneWidget,
      );
    });
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.tap(
          find.byKey(BlocLibraryKeys.extraActionsPopupMenuButton),
        );
        await tester.pump();
    ...
    testWidgets('tapping clear completed adds ClearCompleted', (
      ...
      when(todosBloc.state).thenReturn(
        TodosLoaded([Todo('walk dog'), Todo('take out trash', complete: true)]),
      );
    ...
    testWidgets('tapping toggle all adds ToggleAll', (
      ...
      when(
        todosBloc.state,
      ).thenReturn(TodosLoaded([Todo('walk dog'), Todo('take out trash')]));
